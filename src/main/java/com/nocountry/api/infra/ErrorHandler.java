package com.nocountry.api.infra;
...
public class ErrorHandler {
    ...
    public ResponseEntity<CustomErrorResponse> handleNotValidDateException(NotValidDatetimeException e) {
        CustomErrorResponse customErrorResponse = new CustomErrorResponse(HttpStatus.BAD_REQUEST.value(), e.getMessage());
    ...
    public ResponseEntity<CustomErrorResponse> handleLoginException(LoginException e) {
        CustomErrorResponse customErrorResponse = new CustomErrorResponse(HttpStatus.UNAUTHORIZED.value(), e.getMessage());
