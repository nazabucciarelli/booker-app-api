...
public class AppointmentServiceImpl implements AppointmentService {
    ...
    public AppointmentDTO create(AppointmentInfoDTO appointmentInfoDTO) {
        ...
        for (Appointment ea : employeesAppointments) {
            ...
            boolean isStartTimeWithinReservedInterval = (startTime.isAfter(eaStartTime) || startTime.equals(eaStartTime)) &&
    ...
    public List<LocalTime> listFreeAppointmentsByEmployeeIdAndServiceIdAndDate(Long employeeId,Long serviceId,
        ...
        if (getWorkingDaysListOfEmployee(employee).contains(date.getDayOfWeek())) {
    ...
    private List<DayOfWeek> getWorkingDaysListOfEmployee(Employee employee) {
        List<DayOfWeek> workingDaysList = new ArrayList<>();
        for (char letter : employee.getWorkingDays().toCharArray()) {
            switch (letter) {
                case 'L':
